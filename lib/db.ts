...
const initialEmployees: EmployeeProfile[] = [
  {
    ...
    address: 'Executive HQ, Suite 100, San Francisco, CA 94107',
    avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&auto=format&fit=crop&q=80',
    bio: 'Lead HR Operations Partner & System Administrator for Dayflow Enterprise.',
    emergencyContact: {
    ...
    salary: {
      ...
      bankAccountMasked: '•••• •••• •••• 9901 (Verified)',
      panMasked: 'BHARA••••K',
